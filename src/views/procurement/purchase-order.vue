...
<script>
  ...
  export default {
    ...
    computed: {
      ...mapState(['purchaseOrderStatus', 'purchaseTypes', 'purchaseTypesMap', 
                    'purchaseOrderStatusMap', 'pageData', 'loading', 'purchaseOrder',
                    'goodsList', 'purchaseOrderEdit', 'goodsListEdit'])
    },
    methods: {
      search () {
