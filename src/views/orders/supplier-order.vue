  ...
  export default {
    ...
    data () {
      return {
        ...
        columns: [
          {label: '供应商订单编号', field: 'warehouseOrderCode', width: '263',align:'center'},
          {label: '供应商名称', field: 'supplierName', width: '120',align:'center'},
          {label: '平台订单号', field: 'platformOrderCode', width: '195',align:'center'},
          {label: '店铺订单号', field: 'shopOrderCode', width: '180',align:'center'},
          {label: '商品总数量', field: 'itemsNum', width: '120',align:'center'},
          {label: '商品总金额(元)', field: 'payment', width: '120',align:'center'},
          {label: '付款时间', field: 'payTime', width: '200',align:'center'},
          {
            label: '状态',
            width: '170',
            desField: 'message',
          ...
          {label: '供应商反馈物流公司和运单号', field: 'logisticsInfo', width: '280'},
          {
            label: '操作',
            width: '200',
            align:'center',
        ...
        goodsColumns: [
          {label: 'SKU名称', field: 'itemName', width: '300',align:'center'},
          {label: 'SKU编号', field: 'skuCode', link: '/goods/goods-info', width: '200',align:'center'},
          {label: '供应商SKU编号', field: 'supplierSkuCode', width: '180',align:'center'},
          {label: '供应商反馈订单号', field: 'supplierOrderCode', width: '200',align:'center'},
          {label: '实付总金额（元）', field: 'payment', width: '150',align:'center'},
          {label: '应发商品数量', field: 'num', width: '130',align:'center'},
          {label: '实发商品数量', field: 'deliverNum', width: '125',align:'center'},
          {
            label: '发货状态',
            field: 'supplierOrderStatus',
            width: '160',
