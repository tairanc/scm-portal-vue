<template>
  <div class="instockorder">
    ...
    >
      <el-row :span="24">
        <el-col :span="6">
          <el-form-item label="入库调整单编号：">
            <el-input v-model="searchParams.stockAdjustInCode"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="6">
    ...
    <el-table :data="tableDataList" ref="multipleTable" @row-click="tableRowClick" highlight-current-row border tooltip-effect="dark" height="454">
      ...
      <el-table-column label="入库调整单编号" prop="stockAdjustInCode" align="center"></el-table-column>
      ...
      <el-table-column label="单据状态" prop="stockAdjustInStatusDesc" align="center" show-overflow-tooltip></el-table-column>
    ...
    <el-tabs v-model="activeName" type="card" style="margin-top: 15px;">
      <el-tab-pane label="商品明细" name="1">
        ...
        <el-table :data="tableRowList" style="width: 100%" >
          ...
          <el-table-column prop="inOutInventoryType" label="入库库存类型" align="center" >
            <template slot-scope="scope">
              <span v-show="scope.row.inOutInventoryType == 1">正品</span>
              <span v-show="scope.row.inOutInventoryType == 2">残品</span>
            </template>
          </el-table-column>
          <el-table-column prop="inOutNum" label="入库数量" align="center" show-overflow-tooltip></el-table-column>
          <el-table-column prop="finishTime" label="入库时间" align="center" show-overflow-tooltip></el-table-column>
        </el-table>
        <!-- 分页 -->
        <el-col class='paging'>
...
export default {
  ...
  data() {
    return {
      ...
      operateParams: {
        ...
        pageNumber: 1,
        pageSize: 10,
        entityType: 'WmsStockAdjustInOrder',
        entityId: ''
      }, // 日志
    };
  },
  ...
  methods: {
    ...
    initDataList() {
      ...
      this.logInfoList = [];
      this.logCount = 0;
      this.GET('/adjustInOrder/page', this.searchParams)
        .then(res => {
          ...
          if (this.tableDataList && this.tableDataList.length) {
            setTimeout(() => {
              ...
              this.detailParams.stockAdjustInId = this.tableDataList[0].id;
    ...
    tableRowClick(row) {
      ...
      this.detailParams.stockAdjustInId = row.id;
    ...
    // 获取入库调整单明细数据详情
    getTableDetailList() {
      this.GET('/adjustInOrder/detail', this.detailParams).then(res => {
        console.log('res: ', res);
