...
const getNonorderPage = (params) =>{
  return axios({
    method: 'get',
    url: '/order/exceptionOrderPage',
    params: params
  })
}
const getNonOrderById = (id) => {
  return axios({
    method: 'get',
    url: '/order/exceptionOrder/exceptionOrderCode/' + id
  })
}

const getOutboundOrderPage = (params) =>{
  return axios({
    method: 'get',
    url: '/outOrder/outboundOrderPage',
    params: params
  })
}
const getOutboundWarehouseList =() => {
  return axios({
    method: 'get',
    url: '/outOrder/warehouseListAll'
  })
}

const getOutboundOrderById =(id) => {
  return axios({
    method: 'get',
    url: '/outOrder/outboundOrderDetail/' + id
  })
}
